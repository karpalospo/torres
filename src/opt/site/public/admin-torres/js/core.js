...
var IMP = (function() {
    ...
    callbacks = (components, model, send, mode) => {
...

        {
            ...
            if(typeof component.modelBeforeSet == "function") item.modelBeforeSet(send)
...
handleDatasetEvents = (ds, event, param, mode, component) => {
...
LIST_FORM.prototype.save = async function() {
    ...
    if(result[key].insertId > 1) scrollTo(this.$parent, this.$list.find("tr").last())
